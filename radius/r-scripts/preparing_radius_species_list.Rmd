...
## Toevoegen Sikahert (2440954), Chinese moerasslak (9738098), wilde rijst (10919373)
```{r expanding-anb-species-selection}
ANB_extra <- data.frame(matrix(ncol=5,nrow=3, dimnames=list(NULL, c("Groep","Species","Soort","Lijst","GBIF_code")))) %>%
  mutate(GBIF_code = c("2440954","9738098","10919373"))
...
ANB_extra <- ANB_extra %>%
  mutate(Groep = ifelse(Groep == 'Plantae',"plant","dier"), 
         Lijst = "ANB", 
         Soort = c("Sikahert", "Chinese moerasslak", "Mantsjoerese wilde rijst")) 
```
