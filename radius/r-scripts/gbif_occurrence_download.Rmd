...
write_csv(in_flanders, here("radius", "data", "intermediate", "species_in_flanders.csv"))
write_csv(not_in_flanders, here("radius", "data", "intermediate", "species_not_in_flanders.csv"))
```
...
write_csv(species_list, here("radius", "data", "input", "radius_species_list.csv"))
```
...
write_csv(occ_flanders, here("radius", "data", "input", "gbif_occ_flanders.csv"))
```
