...
write.csv(in_flanders, "./radius/data/intermediate/species_in_flanders.csv", row.names = FALSE)
write.csv(not_in_flanders, "./radius/data/intermediate/species_not_in_flanders.csv", row.names = FALSE)
```

## Save occurrence dataset flanders

```{r save-occurrence-dataset}
write.csv(occ_flanders, "./radius/data/input/gbif_occ_flanders.csv", row.names = FALSE)
```
