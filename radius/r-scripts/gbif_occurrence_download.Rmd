...
gbif_downloadKey <- "0060541-240229165702484" # aangepast 11/03
```
...
occ_filtered <- occ_raw %>%
  ...
  filter(coordinateUncertaintyInMeters <= 100 | is.na(coordinateUncertaintyInMeters)) %>% # wegfilteren van occs met onzekerheid boven 100m
