    ...
    if (nrow(occ_species_intersection) != 0) {  # skip following steps if there's no overlap 
      ...
      if (i == 4) {
        ...
        list.results[[i]] <- rbind(list.results[[i]], data.frame(
          Soort = soort,
          Gebied = "nDomeinen",
          Overlap = length(unique(occ_species_intersection$domeinnaam))))
      ...
      if (i == 5) {
        ...
        list.results[[i]] <- rbind(list.results[[i]], data.frame(
          Soort = soort,
          Gebied = "nNBHP",
          Overlap = length(occ_species_intersection$id)))
...
write.csv(HBTRL, "./radius/data/output/HBTRL.csv", row.names=FALSE)
write.csv(VGLRL, "./radius/data/output/VGLRL.csv", row.names=FALSE)
write.csv(BWKHAB, "./radius/data/output/BWKHAB.csv", row.names=FALSE)
write.csv(PATDAT, "./radius/data/output/PATDAT.csv", row.names=FALSE)
write.csv(NBHP, "./radius/data/output/NBHP.csv", row.names=FALSE)
write.csv(TOP3, "./radius/data/output/TOP3.csv", row.names=FALSE)
```
