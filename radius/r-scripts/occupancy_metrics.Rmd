...
st_write(ps_hbtrl_deel_wgs84, "./radius/data/spatial/WGS84/ps_hbtrl_deel_wgs84.geojson", append = FALSE)
```
...
st_write(ps_vglrl_wgs84, "./radius/data/spatial/WGS84/ps_vglrl_wgs84.geojson", append = FALSE)
```
...
st_write(n2khab_wgs84, "./radius/data/spatial/WGS84/n2khab_wgs84.geojson", append = FALSE)
```
...
st_write(ps_nbhp_wgs84, "./radius/data/spatial/WGS84/ps_nbhp_wgs84.geojson", append = FALSE)
```
