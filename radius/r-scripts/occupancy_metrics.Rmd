...
write_csv(PATDAT_incl_ob_long, "./radius/data/output/PATDAT_incl_ob_long.csv")
write_csv(PATDAT_excl_ob_long, "./radius/data/output/PATDAT_excl_ob_long.csv")
write_csv(NBHP_long, "./radius/data/output/NBHP_long.csv")
write_csv(SBP_pls_long, "./radius/data/output/SBP_pls_long.csv")
write_csv(SBP_pgs_long, "./radius/data/output/SBP_pgs_long.csv")
...
write_csv(PATDAT_incl_ob_wide, "./radius/data/output/PATDAT_incl_ob_wide.csv")
write_csv(PATDAT_excl_ob_wide, "./radius/data/output/PATDAT_excl_ob_wide.csv")
write_csv(NBHP_wide, "./radius/data/output/NBHP_wide.csv")
write_csv(SBP_pgs_wide, "./radius/data/output/SBP_pgs_wide.csv")
write_csv(SBP_pls_wide, "./radius/data/output/SBP_pls_wide.csv")
