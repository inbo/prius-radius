...
saveRDS(ps_hbtrl_deel, "./radius/data/spatial/ps_hbtrl_deel.RData", compress = "xz")
...
saveRDS(ps_hbtrl_deel_wgs84, "./radius/data/spatial/WGS84/ps_hbtrl_deel_wgs84.RData", compress = "xz")
```
...
saveRDS(ps_vglrl_wgs84, "./radius/data/spatial/WGS84/ps_vglrl_wgs84.RData", compress = "xz")
```
...
saveRDS(n2khab_wgs84, "./radius/data/spatial/WGS84/n2khab_wgs84.RData", compress = "xz")
```
...
saveRDS(am_patdat_wgs84, "./radius/data/spatial/WGS84/am_patdat_wgs84.RData", compress = "xz")
```
...
saveRDS(ps_nbhp_wgs84, "./radius/data/spatial/WGS84/ps_nbhp_wgs84.RData", compress = "xz")
```
