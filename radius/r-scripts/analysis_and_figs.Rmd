...
soorten <- c("Siberische grondeekhoorn", "sikahert", "Chinese moerasslak", "kleine waterteunisbloem", "watercrassula", "heilige ibis", "Amerikaanse hondsvis", "rosse stekelstaart", "Chinese muntjak", "Turkse rivierkreeft")
...
data_filtered <- data %>%
  ...
  bind_rows(
    data %>%
      ...
      mutate(gebied = "Buiten ANB", overlap = buiten_patdat) %>%
