...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/HBTRL/Fig_23_update.png", 
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/HBTRL/Fig_22_update.png", 
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/HBTRL/Fig_20_update.png", 
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/HBTRL/Fig_21_update.png", 
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VGLRL/Fig_19_update.png", 
       width = 23, height = 10, units = "cm", dpi=300)
...
# ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VGLRL/Fig_16_update.png",
#        width = 23, height = 10, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VGLRL/Fig_17_update.png", 
       width = 23, height = 15, units = "cm", dpi=300)
...
combined_plot +
  theme(
    ...
    plot.tag = element_text(size = 90)
  )

ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VGLRL/Fig_18_update.png", 
       width = 23, height = 17, units = "cm", dpi=300)
...
z$opp <- units::set_units(z$opp, ha)
z$opp <- round(as.numeric(z$opp), 2)

y <- N2KHAB %>%
  dplyr::filter(gebied != "N2KHAB" & type == "of" & overlap != 0) %>%
  left_join(species_list, by = c("soort" = "Soort"), relationship = "many-to-many") %>%
  left_join(habitats, by = c("gebied" = "code")) %>%
  left_join(z, by = c("gebied" = "code")) %>%
  select(Groep, soort, groep, gebied, habitat, opp, overlap) %>%
  distinct() %>%
  group_by(groep, gebied, opp) %>%
  summarise(n_spec = n()) %>%
  ungroup() %>%
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/Fig_28_update.png",
       width = 23, height = 13, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/Fig_27_update.png",
       width = 23, height = 13, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/Fig_25_update.png",
       width = 23, height = 27, units = "cm", dpi=300)
...
ggplot(data = x, aes(x = reorder_within(gebied, overlap, groep), y = ifelse(overlap != 0 & overlap < 0.05, overlap * 100 + 0.1, overlap * 100))) +
  geom_bar(stat = "identity", width = 0.7, fill = "#cc6999") +
  facet_grid(soort ~ groep, scales = "free_x", space = "free_x", labeller = labeller(groep = facet_labels)) +
  labs(x="Habitattype", y = "Specificiteit") +
  scale_x_reordered() +
  scale_y_continuous(expand = expansion(mult = c(0, 0.05)), labels = scales::percent_format(scale = 1)) +
  custom_theme() +
  theme(
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/Fig_26_update.png",
       width = 23, height = 20, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/NBHP/Fig_29_update.png", width = 23, height = 10, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/NBHP/Fig_30_update.png",
       width = 23, height = 15, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/NBHP/Fig_31_update.png", 
       width = 23, height = 15, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/Fig_33_update.png", width = 23, height = 10, units = "cm", dpi=300)
...
ggplot() +
  ...
  coord_equal(ratio = 1) +
  labs(x = "Bezetting Vlaanderen", y = "Bezetting ANB-patrimonium") +
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/Fig_32_update.png",
       width = 23, height = 13, units = "cm", dpi=300)
...
label_colors <- setNames(data$label_color, data$soort)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/SBP/Fig_35_update.png",
       width = 23, height = 10, units = "cm", dpi=300)
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/SBP/Fig_36_update.png",
       width = 23, height = 10, units = "cm", dpi=300)
...
ggplot() +
  ...
  geom_sf(data = sbp_pls_intersect_n, aes(color = soort, fill = soort), linewidth = 3, alpha = 1) +
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/SBP/Fig_37_update.png",
       width = 23, height = 10, units = "cm", dpi=300)
