...
```{r}
list.dfs <- list(df_nbhp = data.frame(), df_patdat = data.frame())

for (i in c("Siberische grondeekhoorn", "kleine waterteunisbloem", "sikahert", "Chinese moerasslak", "Turkse rivierkreeft")) { 
  
  occ_species <- occ_flanders %>%
    st_transform(31370) %>%
    filter(Soort == i) 
  
  occ_intersection_nbhp <- occ_species %>%
    st_intersection(ps_nbhp) %>% 
    st_drop_geometry() %>%
    distinct() 

  list.dfs[[1]] <- rbind(list.dfs[[1]], data.frame(occ_intersection_nbhp))
  
  occ_intersection_patdat <- occ_species %>%
    st_intersection(am_patdat) %>% 
    st_drop_geometry() %>%
    distinct() 
  
  list.dfs[[2]] <- rbind(list.dfs[[2]], data.frame(occ_intersection_patdat))
}

# Samenvattingen maken
df_nbhp_summary <- list.dfs[[1]] %>%
  transmute(Soort, namdssr, ntrbhrp, egndmty) %>%
  distinct()

write_csv2(df_nbhp_summary, "G:/Mijn Drive/Fleur/RadIUS/Rapport/tabellen/voorkomen_nbhrplannen.csv")

df_patdat_summary <- list.dfs[[2]] %>%
  transmute(Soort, domennm, regio, rchtnnb) %>%
  distinct()

write_csv2(df_patdat_summary, "G:/Mijn Drive/Fleur/RadIUS/Rapport/tabellen/voorkomen_anbdomeinen.csv")
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VL/vl_bezetting.png", width = 23, height = 20, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/vl_bezetting.png", width = 23, height = 20, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/HBTRL/hbtrl_nspec.png", 
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/HBTRL/hbtrl_spec_per_gebied.png", 
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/HBTRL/hbtrl_bezetting.png", 
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/HBTRL/hbtrl_in_vs_of.png", 
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/HBTRL/hbtrl_Up_Cn_Tsi.png", 
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VGLRL/vglrl_nspec.png", 
       width = 23, height = 10, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VGLRL/vglrl_spec_per_gebied.png", 
       width = 23, height = 17, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VGLRL/vglrl_bezetting.png", 
       width = 23, height = 10, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VGLRL/vglrl_in_vs_of.png", 
       width = 23, height = 15, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VGLRL/vglrl_Oj_Ta.png", 
       width = 23, height = 17, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/n2khab_nspec.png", 
       width = 23, height = 15, units = "cm", dpi=300)
...
##### Verspreiding van mate van bezetting
```{r}
y <- N2KHAB %>%
  dplyr::filter(gebied != "N2KHAB" & type == "of" & overlap != 0) %>%
  left_join(species_list, by = c("soort" = "Soort"), relationship = "many-to-many") %>%
...
y$max_overlap <- y$max_overlap * 100

breaks <- c(0, 0.000001, seq(10, 100, by = 10))
labels <- c("0%", paste0(">0-10%"), paste0(seq(10, 90, by = 10), "-", seq(20, 100, by = 10), "%"))

y$overlap_categorie <- cut(y$max_overlap, 
                           breaks = breaks,
                           labels = labels,
                           include.lowest = TRUE,
                           right = FALSE)
z <- y %>%
  group_by(overlap_categorie) %>%
  summarise(n_habitats = n())

ggplot(z, aes(x = overlap_categorie, y = n_habitats)) +
  geom_bar(stat = "identity", fill = "#c04384", width = 0.7) +
  scale_y_continuous(
    expand = expansion(mult = c(0, 0.01)),
    breaks = function(x) seq(floor(min(x)), ceiling(max(x)), by = 2)
  ) +
  labs(x = "Maximale bezetting", y = "Aantal habitats") +
  custom_theme() +
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/n2khab_bezetting_per_type.png", 
       width = 23, height = 13, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/2khab_bezetting_per_type.png", 
       width = 23, height = 13, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/n2khab_bezetting_per_groep.png", 
       width = 23, height = 13, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/2khab_bezetting_per_groep.png", 
       width = 23, height = 13, units = "cm", dpi=300)
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/n2khab_bezetting.png", 
       width = 23, height = 27, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/n2khab_in_vs_of.png", 
       width = 23, height = 15, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/N2KHAB/n2khab_vgl_species.png",
       width = 23, height = 20, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/n2khab_vgl_species.png",
       width = 23, height = 20, units = "cm", dpi=300)
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/NBHP/NBHP_nspec_per_type.png", 
       width = 23, height = 15, units = "cm", dpi=300)
...
#ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/NBHP/nbhp_bezetting_top5.png", width = 23, height = 10, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/nbhp_bezetting_top5.png", 
       width = 23, height = 10, units = "cm", dpi=300)
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/NBHP/nbhp_top10_voorkomen.png", 
       width = 23, height = 15, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/nbhp_top10_voorkomen.png", 
       width = 23, height = 15, units = "cm", dpi=300)
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/NBHP/nbhp_in_vs_of.png", 
       width = 23, height = 15, units = "cm", dpi=300)
...
soorten <- c("Siberische grondeekhoorn", "kleine waterteunisbloem", "Chinese moerasslak", "sikahert", "rosse stekelstaart", "beverrat", "Noord-Aziatische modderkruiper", "waterhyacint", "watercrassula", "marmerkreeft")
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/NBHP/nbhp_resp.png", 
       width = 23, height = 15, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/nbhp_resp.png", 
       width = 23, height = 15, units = "cm", dpi=300)
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/patdat_nspec_per_br.png", width = 23, height = 10, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/patdat_nspec_per_br.png", 
       width = 23, height = 10, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/patdat_bezetting_top10.png",
       width = 23, height = 10, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/patdat_bezetting_top10.png", 
       width = 23, height = 10, units = "cm", dpi=300)
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/patdat_spec_top5.png",
       width = 23, height = 10, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/patdat_spec_top5.png", 
       width = 23, height = 10, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/patdat_ndom_per_recht.png", 
       width = 23, height = 10, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/patdat_ndom_per_recht.png", 
       width = 23, height = 10, units = "cm", dpi=300)
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/patdat_perc_per_br.png",
       width = 23, height = 13, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/ofVl_vs_ofPATDAT.png",
       width = 23, height = 13, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/ofVl_vs_ofPATDATr.png",
       width = 23, height = 13, units = "cm", dpi=300)
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/PATDAT_max5_per_br.png",  width = 3.1, height = 8, units = "in", dpi=300)
ggsave("./radius/data/output/figuren/patdat_max5_per_br.png",
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/PATDAT/PATDAT_min5_per_br.png",  width = 3.1, height = 8, units = "in", dpi=300)
ggsave("./radius/data/output/figuren/patdat_min5_per_br.png",
       width = 3.1, height = 8, units = "in", dpi=300)
...
sbp_pls_species <- c("Amerikaanse stierkikker", "Kesslergrondel", "Pontische stroomgrondel", "marmergrondel", "zwartbekgrondel", "Californische rivierkreeft", "gestreepte Amerikaanse rivierkreeft", "gevlekte Amerikaanse rivierkreeft", "rode Amerikaanse rivierkreeft", "Turkse rivierkreeft","Chinese wolhandkrab"
) 
```
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/SBP/sbp_bezetting.png",
       width = 23, height = 16, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/sbp_bezetting.png",
       width = 23, height = 16, units = "cm", dpi=300)
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/SBP/sbp_bezetting2.png",
       width = 23, height = 10, units = "cm", dpi=300)

# actueel voorkomen vs uitbreiding
data <- SBP_pls_extra %>%
  filter(type %in% c("of_sbp_al", "of_sbp_ul"))
```
...
species_order <- c("Pontische stroomgrondel", "marmergrondel", "Kesslergrondel",
                   ...
                   "rode Amerikaanse rivierkreeft", "Californische rivierkreeft")
...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/SBP/sbp_nspec_per_cluster.png",
       width = 23, height = 10, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/sbp_nspec_per_cluster.png",
       width = 23, height = 10, units = "cm", dpi=300)
...
lu_sbp_pls_n <- lu_sbp_pls %>%
  st_intersection(cluster_kn)

sbp_pls_intersect_kn <- sbp_pls_intersects %>%
  st_intersection(cluster_kn)
...
ggplot() +
  ...
  geom_sf(data = lu_sbp_pls_kn, color = "lightblue3", linewidth = 1) +
  geom_sf(data = sbp_pls_intersect_kn, aes(color = soort, fill = soort), linewidth = 3, alpha = 1) +
...
ggsave("./radius/data/output/figuren/sbp_nete.png",
       width = 23, height = 10, units = "cm", dpi=300)
```

```{r spec-in-grote nete}
cluster_gn <- clusters_sbp %>% filter(CLUSTERNAAM == "middenloop en benedenloop Grote Nete")

lu_sbp_pls_gn <- lu_sbp_pls %>%
  st_intersection(cluster_gn)

sbp_pls_intersect_gn <- sbp_pls_intersects %>%
  st_intersection(cluster_gn)


plot2 <- ggplot() +
  geom_sf(data = clusters_sbp %>% filter(CLUSTERNAAM == "middenloop en benedenloop Grote Nete")) +
  #geom_sf(data = Provincies_grenzen, fill = "#f0f0f0", linewidth = 0.2) +
  geom_sf(data = lu_sbp_pls_gn, color = "lightblue3", linewidth = 1) +
  geom_sf(data = sbp_pls_intersect_gn, aes(color = soort, fill = soort), linewidth = 2, alpha = 1) +
  scale_fill_manual(values = palet, drop = FALSE, na.translate = FALSE) +
  scale_color_manual(values = palet, drop = FALSE, na.translate = FALSE) +
  theme_map() +
  theme(
    legend.position = "none",
    legend.title = element_blank(),
...
# Haal de legende van een van de plots
shared_legend <- get_legend(
  ggplot() +
    geom_sf(data = sbp_pls_intersect_kn, aes(color = soort, fill = soort)) +
    scale_fill_manual(values = palet, drop = FALSE, na.translate = FALSE) +
    scale_color_manual(values = palet, drop = FALSE, na.translate = FALSE) +
    theme(legend.position = "bottom",
          legend.title = element_blank(),
...
# Combineer de plots met de gedeelde legende
final_plot <- combined_plot / shared_legend +
