...
ggsave("G:/.shortcut-targets-by-id/0B0xcP-eNvJ9dMGhEZjVoT28tVVk/PRJ_FAUNABEHEER/INBOPRJ-21105 - RadIUS/5_Rapport/Figuren & tabellen/Resultaten/VL/vl_bezetting.png", 
       width = 23, height = 20, units = "cm", dpi=300)
ggsave("./radius/data/output/figuren/vl_bezetting.png", 
       width = 23, height = 20-, units = "cm", dpi=300)
...
ggplot() +
  geom_text(data = x, aes(x = ofVL, y = ofPATDAT, label = abbr), size = 3) +
  geom_abline() +
