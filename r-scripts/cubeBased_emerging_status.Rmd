...
write_tsv(em_decision_rules_occupancy_FL_2020,
          './data/output/emerging_status/output_decision_rules_occupancy_FL_2020.tsv', na = "")

em_decision_rules_occupancy_pa_2020 <- em_decision_rules_occupancy_pa %>% 
  filter(year == 2020) %>% 
  left_join(species_list, by= c('taxonKey'='GBIF_code'))

write_tsv(em_decision_rules_occupancy_pa_2020,
          './data/output/emerging_status/output_decision_rules_occupancy_pa_2020.tsv', na = "")
```
...
write_csv(test, paste0("./data/output/emerging_status/output_GAM_", method_em, "_occupancy_FL_2020.csv"))
...
write_csv(test, paste0("./data/output/emerging_status/output_GAM_", method_em, "_occupancy_pa_2020.csv"))
```