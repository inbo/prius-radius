...
```{r download be_species_cube.csv}
if(!file.exists("./data/input/be_species_cube.csv")){
  download.file(url = "https://zenodo.org/record/4299787/files/be_species_cube.csv?download=1",
                destfile = "./data/input/be_species_cube.csv")
}
```
