...
This figure in the report shows the number of unique grid cells occupied by the species in Flanders. It is based on output regarding the distribution maps (cubeBased_distribution_maps.Rmd). (Can also from cubeBased_occupancy_Natura2000.Rmd and its output.)
...
# data <- read.csv("./data/output/occupancy_Natura2000/occupancy_Natura2000.csv") # Alternatief
