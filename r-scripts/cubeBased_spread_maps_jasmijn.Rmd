...
```{r get species list}
species_list <- read_csv('https://raw.githubusercontent.com/inbo/prius/f52fc4e0bb060d5a3d372d1650502602a0a562fd/data/input/prius_species_list.csv') 
```
...
for (species_name in unique(in_cube$Soort)){
  ...
  ggsave(temp_plot, file=paste0("./data/output/spread_maps/plot_", species_name,".png"), width = 14, height = 10, units = "cm")
}
```
